...
start "Backend App-Alquiler" cmd /k "cd /d c:\Aure\desarrollos\javascript\workspace-aure\backend\app-alquiler && echo Iniciando Backend en puerto 8080... && deno run --allow-all src/main.ts"
...
echo    - Backend: Servidor Deno en puerto 8080
